...
<html lang="en" dir="ltr">
	<head>
		...
		<title> MM autohaven | Главная</title>
	</head>
	<body>
		<section class="head">
			<header>
				...
				<nav>
					<ul>
						<li class="to-home">Главная</li>
						<li class="to-login">Вход</li>
						<li class="to-stories">Сторисы</li>
						<li class="to-cars">Машины</li>
						<li class="to-my-thoughts">Новости</li>
						<li class="to-gallary">Галерея</li>
					</ul>
				</nav>
			</header>
		</section>
			...
			<div class="showcase-text" data-aos="slide-up">
                <p class="error">
                    ...
                    if(isset($_SESSION['log_message'])){
                        ...
                        if($_SESSION['sign_message'] == "Аккаунт успешно создан"){
				...
				<div class="login-signup">
					<h4 class="login active-form">Вход</h4>
					<h4 class="signup">Регистрация</h4>
				</div>
				<div class="forms">
					<form class="login-form" action="index.php" method="post">
						<input type="email" name="email" placeholder="Email"> <br>
		                <input type="password" name="password" placeholder="Password"> <br>
		                <button type="submit" name="login-submit"> Вход </button>
					</form>
				...
				<h1>Спорткары</h1>
				<p>Лучшие автомобили за всю историю.</p>
			</div>
		...
		<section class="stories">
			<h1 data-aos="slide-down">История</h1>
		...
		<section class="cars">
			<h1> Машины </h1>
			<h4 class="regular  active-cars">Повседневная</h4>
			<h4 class="sports">Спортивная</h4>
			<h4 class="off-road">Повышенной проходимости</h4>
			...
			<div class="cars-container1">
                        ...
                        if($row['car_type'] == 'Regular' & $i <= 8){
                            echo '<div class="box" data-aos="slide-up">
            					 ...
            					 <form class="" action="product.php?id='.$row['id'].'" method="post">
            					 	<button type="submit" name="add-to-cart-index">Добавить в корзину</button>
            					 </form>
            				</div>';
                            $i++;
                        }
                ...
                <div class="more">
                    <a class="more-btn" href="more.php?type=Regular"><i class="fas fa-angle-double-right"><span>Ещё</span> </i></a>
                </div>
			</div>
			<div class="cars-container2">
                ...
                <div class="more">
                    <a class="more-btn" href="more.php?type=Sports"><i class="fas fa-angle-double-right"><span>Ещё</span> </i></a>
                </div>
			</div>
			<div class="cars-container3">
                ...
                <div class="more">
                    <a class="more-btn" href="more.php?type=all_cars"><i class="fas fa-angle-double-right"><span>Ещё</span> </i></a>
                </div>
		</section>
		...
		<section class="my-thoughts">
			<div class="my-thoughts-container">
                ...
                <div class="more" style="text-align: center;">
                    <a class="more-btn" href="more.php?post=all_post"><i class="fas fa-angle-double-right"><span>Ещё</span> </i></a>
                </div>
			</div>
		</section>
			...
			<div class="gallary-img">
                <?php
                    ...
                    echo '<div class="row">
    				  <div class="column">
    					  <div class="overlay">
    						  <h4>Кликни чтобы появилась картинка</h4>
