...
<html lang="en" dir="ltr">
	<head>
		...
		<title>M&K autohaven | Товары</title>
	</head>
	<body>
		<div class="container">
			<div class="nav">
				<a href="javascript:history.back();"><i class="fas fa-angle-double-left"></i></a><h1>M&K autohaven</h1>
			</div>
			<?php
        				...
        				<div class="image">
        					<div class="pro-info">
        						...
        						<form action="product.php?id='.$row['id'].'" method="post">
        						   <button class="add-to-cart" type="submit" name="add-to-cart">Купить</button>
        						   <button type="button" class="call"><i class="fas fa-phone"></i></button>
        						   <button type="button" class="mail"><i class="fas fa-envelope"></i></button>
        						</form>
        					</div>
